...
public class Enemy_spawner : MonoBehaviour
{
    ...
    IEnumerator SpawnAnEnemy(){
        ...
        if(GameplayManager.instance.spawn){
            //Level 1 - Some monsters spawn, mostly demons
            if(Random.value < 0.0001 && GameplayManager.instance.levelNumber == 1 && GameObject.FindGameObjectsWithTag("M_Enemy").Length < 3){ 
