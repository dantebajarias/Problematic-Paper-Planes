...
public class Enemy_spawner : MonoBehaviour
{
    ...
    IEnumerator SpawnAnEnemy(){
        ...
        if(GameplayManager.instance.spawn){
            ...
            }else if(GameplayManager.instance.levelNumber == 3){
                Instantiate(enemies[1], spawnPos, Quaternion.identity);
            }else if(Random.value < 0.6 && GameplayManager.instance.levelNumber == 4){
                Instantiate(enemies[1], spawnPos, Quaternion.identity);
            }else if(GameplayManager.instance.levelNumber == 5){
                Instantiate(enemies[2], spawnPos, Quaternion.identity);
            }else if(Random.value < 0.4 && GameplayManager.instance.levelNumber == 6){
                Instantiate(enemies[2], spawnPos, Quaternion.identity);
            }else{
